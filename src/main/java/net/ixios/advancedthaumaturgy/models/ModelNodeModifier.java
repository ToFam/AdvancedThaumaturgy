...
public class ModelNodeModifier implements IModelContainer
{
	...
	public static final WavefrontObject model = 
			(WavefrontObject)AdvancedModelLoader.loadModel(new ResourceLocation(AdvThaum.MODID, "models/thaum_node_modifier_2.obj"));
