...
public class WailaEssentiaEngineHandler implements IWailaDataProvider 
{
	...
	public List<String> getWailaBody(ItemStack itemStack, List<String> currenttip, 
			IWailaDataAccessor accessor, IWailaConfigHandler config) 
	{
		TileEssentiaEngine engine = (TileEssentiaEngine) accessor.getTileEntity();
		currenttip.add("RF: " + engine.getEnergyStored(null) + "/" + engine.getMaxEnergyStored(null));
		return currenttip;
	}
